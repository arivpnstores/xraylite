...
wget -q https://raw.githubusercontent.com/arivpnstores/xraylite/main/tools.sh && chmod +x tools.sh && ./tools.sh
rm tools.sh
clear
# izin
MYIP=$(wget -qO- ipinfo.io/ip);
...
CEKEXPIRED () {
        ...
        Exp1=$(curl -sS https://raw.githubusercontent.com/arivpnstores/permission/main/ip | grep $MYIP | awk '{print $3}')
        if [[ $today < $Exp1 ]]; then
...
IZIN=$(curl -sS https://raw.githubusercontent.com/arivpnstores/permission/main/ip | awk '{print $4}' | grep $MYIP)
if [ $MYIP = $IZIN ]; then
echo "IZIN DI TERIMA!!"
CEKEXPIRED
else
...
sleep 2
clear
wget -q -O ssh-vpn.sh https://raw.githubusercontent.com/arivpnstores/xraylite/main/ARISCTUNNEL/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
sleep 2
clear
...
sleep 2
clear
wget https://raw.githubusercontent.com/arivpnstores/xraylite/main/Insshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
...
echo "------------------------------------------------------------"
echo ""
echo "===============-[ Script Credit By ARISCTUNNEL ]-==============="
echo -e ""
echo ""
echo "" | tee -a log-install.txt
echo "ADIOS"
